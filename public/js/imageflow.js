...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		reflectPath:        '../../public/',             /* Path to the reflect_.php script */
	...
	this.init = function (options)
	{
		...
		if(ImageFlowDiv)
		{
			...
			if(this.createStructure())
			{
				...
				ImageFlowDiv.style.height = '300px';//height + 'px';
	...
	this.glideTo = function(imageID)
	{
		...
		var caption_alt = my.imagesDiv.childNodes[imageID].getAttribute('tag-id');
		if (caption === '' || my.captions === false)
		{
			caption = '&nbsp;';
		}
		my.captionDiv.innerHTML = caption;
		my.captionDiv.title = caption_alt;
